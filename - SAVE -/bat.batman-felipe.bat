...
echo BOM TRABALHO.
(
echo VERSAO ANTERIOR: %dataModificacao5%
echo.
echo TECNICO RESPONSAVEL: %User% 
echo VERSAO PCT: %dataModificacao6% (OFICIAL) 
echo INICIO ATT: %HoraInicio% 
echo FIM ATT: %HoraFim% 
echo. 
echo - VERIFICADO SE EXCLUIU O MSGATUALIZA.TXT DA RAIZ DO SISPLAN; 
echo - ATUALIZADO PARAMETROS E CONSULTADO OS MENUS DO SISTEMA; 
echo - INICIADO OS SERVICOS QUE FORAM PARADOS; 
echo - COMPACTADO O BACKUP; 
echo.
) > "%Caminho%\Agora\BackupATT\Backup_%DataAtual%\Complete.txt"
